...
const pages={dashboard:'Executive',companies:'Badan Usaha',organization:'Cabang & Departemen','daily-income':'Pendapatan Harian',transactions:'Transaksi',approvals:'Approval',arap:'AR / AP',reconciliation:'Rekonsiliasi',periods:'Closing',reports:'Laporan Keuangan',cashbank:'Cash & Bank',budget:'Budget',assets:'Aset',intercompany:'Intercompany',tax:'Pajak',fx:'Multi-Currency',analytics:'Analytics',integrations:'Integrasi',backup:'Backup',audit:'Audit',settings:'Pengaturan'};
