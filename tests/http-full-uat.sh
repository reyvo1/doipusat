...
pages=(dashboard companies daily-income transactions approvals arap reconciliation periods reports cashbank budget assets intercompany tax fx analytics integrations backup audit settings)
...
echo "PASS HTTP full UAT: 20 pages + daily income + 6 reports + 18 exports + backup + integration"
